...
```bash
python task7_qsp/run_task7_qsp_tumor_immune_pkpd_synergy.py --self-test
python task7_qsp/run_task7_qsp_tumor_immune_pkpd_synergy.py --out task7_reproduction
python task7_qsp/run_task7_qsp_tumor_immune_pkpd_synergy.py --write-example qsp_parameters.json
python task7_qsp/run_task7_qsp_tumor_immune_pkpd_synergy.py --config qsp_parameters.json --out task7_custom
