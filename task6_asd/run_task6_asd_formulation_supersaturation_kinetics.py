...
Run: python run_task6_asd_formulation_supersaturation_kinetics.py --out NEW_DIR
"""
...
def self_test():
    suite=unittest.defaultTestLoader.discover(str(ROOT.parent/"tests"),pattern="test_task6.py")
