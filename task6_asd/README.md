...
python task6_asd/run_task6_asd_formulation_supersaturation_kinetics.py --write-example work/task6_parameters.json
python task6_asd/run_task6_asd_formulation_supersaturation_kinetics.py --config work/task6_parameters.json --out work/task6_custom
```
