...
从仓库根目录运行 `python projects/task03_covalent_kinetics/run_task3_covalent_kinetics_residence_time.py --help` 查看参数。
正式复现附加 `--output-dir work/task03_reproduction`，使新输出与本项目归档结果分开。
