...
TASK4_PATH = HERE.parent / 'task04_pbpk/run_task4_pbpk_pharmacokinetics_dose_prediction.py'
...
def self_test():
    import unittest
    suite=unittest.defaultTestLoader.discover(str(HERE.parents[1]/'tests'),pattern='test_task5.py')
